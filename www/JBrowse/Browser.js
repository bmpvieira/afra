...
initView: function() {
    ...
    return this._milestoneFunction('initView', function( deferred ) {
        ...
        this.addGlobalMenuItem('options', cds_frame_toggle);
        var plus_strand_toggle = new dijitCheckedMenuItem(
            ...
            onClick: function(event) {
                ...
                if (plus && minus)  {
                    this.view.featureFilter = this.view.passAllFilter;
                }
                else if (plus)  {
                    this.view.featureFilter = this.view.plusStrandFilter;
                }
                else if (minus)  {
                    this.view.featureFilter = this.view.minusStrandFilter;
                }
                else  {
                    this.view.featureFilter = this.view.passNoneFilter;
                }
                thisB.redoLayout();
            }
        });
        this.addGlobalMenuItem('options', plus_strand_toggle);
        ...
        this.addGlobalMenuItem('options', minus_strand_toggle);
        // GUI options from WA //
        // -- yebs
