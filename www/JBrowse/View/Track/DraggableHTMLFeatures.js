 ...
 */
    ...
    */
    ...
    onFeatureMouseDown: function(event) {
        ...
        // drag_create conditional needed in older strategy using
        // trigger(event) for feature drag bootstrapping with JQuery 1.5, but
        // not with with JQuery 1.7+ strategy using _mouseDown(event), since
        // _mouseDown call doesn't lead to onFeatureMouseDown() call
        //
                ...
                $featdiv.draggable(   // draggable() adds "ui-draggable" class to div
                    {
                       ...
                       helper: function() {
                        ...
                        opacity: 0.5,
                        axis: 'y'
                        // drag_create setting in create() needed by older drag
                        // bootstrapping strategy with JQuery 1.5, but not with
                        // different JQuery 1.7+ strategy,
                        // create: function(event, ui)  { ftrack.drag_create = true; }
                } );

                // Want to be able to both make feature draggable and initiate
                // actual dragging with the same mousedown event to do this
                // need to retrigger/simulate the mousedown event again see
                // http://bugs.jqueryui.com/ticket/3876 regarding switch from
                // previous hacky approach using JQuery 1.5:
                //
