define( [
        ...
        function( declare, $, draggable, droppable, resizable, 
		  ...
		  DraggableFeatureTrack, FeatureSelectionManager, JSONUtils, BioFeatureUtils, SequenceSearch, 
...
//		if (tracks[i].config.type ==  "WebApollo/View/Track/AnnotSequenceTrack")  {
    ...
    */
    ...
    addToAnnotation: function(annot, feature_records)  {
        console.log(annot);
        console.log(feature_records);

        var feature = feature_records[0].feature;
        feature._parent = annot;
        annot[12].push(feature);
        this.changed();
...
////              parent.uniquename = annot[target_track.fields["name"]];
        ...
        $(target_trackdiv).droppable(  {
            ...
            deactivate: function(event, ui)  {
                ...
                if (target_track.annot_under_mouse != null)  {
                    ...
                    target_track.create_annotations(dropped_feats);
                }
    ...
    create_annotations: function(dropped_feats)  {
            var target_track = this;
            for (var i in dropped_feats)  {
                target_track.store.insert(dropped_feats[i].feature);
